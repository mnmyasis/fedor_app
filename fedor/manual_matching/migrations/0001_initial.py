    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eas_dict', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='directory.synceas')),
                ('sku_dict', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='directory.syncsku')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateField(auto_now_add=True)),
                ('update_date', models.DateField(auto_now=True)),
                ('eas_dict', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='directory.synceas')),
                ('sku_dict', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='directory.syncsku')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
